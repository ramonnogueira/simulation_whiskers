...
class sparse_autoencoder_1(sparse_autoencoder):
    def __init__(self,n_inp,n_hidden,sigma_init,k=2):
        super(sparse_autoencoder_1,self).__init__(n_inp,sigma_init,k=2)
...
class sparse_autoencoder_2(sparse_autoencoder):
    def __init__(self,n_inp,n_hidden,sigma_init,k=2):
        super(sparse_autoencoder_2,self).__init__(n_inp,sigma_init,k=2)
        self.n_inp=n_inp
        self.n_hidden=n_hidden
        self.sigma_init=sigma_init
...
class sparse_autoencoder_3(sparse_autoencoder):
    def __init__(self,n_inp,n_hidden,sigma_init,k=2):
        super(sparse_autoencoder_3,self).__init__(n_inp,sigma_init,k=2)
        self.n_inp=n_inp
        self.n_hidden=n_hidden
        self.sigma_init=sigma_init
        self.enc=torch.nn.Linear(n_inp,n_hidden[0])
